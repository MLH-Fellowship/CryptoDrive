...
import etherum from "./../../assets/images/ethpurple.png";
import ipfs from "./../../assets/images/ipfs.svg";
        ...
        <div className={innerClasses}>
          ...
          <div className={splitClasses}>
            <div className="split-item">
              ...
              >
                ...
                <p className="m-0">
                  ...
                  hacks. Only the username and public key are stored in the smart
            ...
            <div className="split-item">
              ...
              >
                <div className="text-xxs text-color-primary fw-600 tt-u mb-8"></div>
                <h3 className="mt-0 mb-12"> Encrypted Storage</h3>
                <p className="m-0">
                  CryptoDrive uses Interplanetary File System, A peer-to-peer
                  hypermedia protocol designed to make the web faster, safer,
                  and more open, along with AES-512bit Encryption which makes it
                  impossible to steal or misuse data.
                </p>
              </div>
              <div
                className={classNames(
            ...
            <div className="split-item">
              ...
              >
                <div className="text-xxs text-color-primary fw-600 tt-u mb-8"></div>
                <h3 className="mt-0 mb-12">Privacy</h3>
                <p className="m-0">
